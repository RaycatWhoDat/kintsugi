...
; TYPE SYSTEM
; ============================================================
; Gradual typing. Type introspection, conversion, and custom
; typesets. No implicit coercion. Type annotations on function
; params are enforced at runtime.
...
; --- Where clauses (guarded typesets) ---
positive!: typeset/where [integer!] [it > 0]
...
; try returns a result! block with a known shape:
...
; LIFECYCLE HOOKS
; ============================================================
; @enter and @exit fire at scope boundaries inside any
; evaluated block.
;
...
; SHAPES & VALIDATION
; ============================================================
; Shapes are parse rules used as data contracts.
; Convention: ~ suffix for shape names.
...
; Shapes compose — they're just blocks.
